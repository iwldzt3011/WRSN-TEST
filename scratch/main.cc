...
int main (int argc, char *argv[])
{
  ...
  for(int j = 0;j < c.GetN();j++){
    ...
    wsngr::RoutingProtocol::nodes[ip] = wsngr::NodeInfo{j,ip,p->GetObject<MobilityModel>()->GetPosition(),wsngr::NodeInfo::MAX_ENERGY,wsngr::NodeInfo::MAX_ENERGY,Simulator::Now(),wsngr::NodeState::WORKING};
  }
  //charger::Maximum_Independent_Sets();
  ...
  Simulator::Schedule(Seconds(15),print_nodes);
  Simulator::Schedule(Seconds(25),charger::Maximum_Independent_Sets);
